...
exports.handler = async function (event) {
  ...
  var shipping = {};
  ["nombre", "email", "telefono", "dni", "cp", "sucursalId", "sucursalNombre", "sucursalCalle", "sucursalNumero", "sucursalLocalidad", "sucursalProvincia", "sucursalCp"].forEach(function (key) {
