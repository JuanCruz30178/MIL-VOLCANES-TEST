(function () {
  ...
  "es": {
    ...
    "ship-label-dni": "DNI",
    "ship-label-direccion": "Dirección (calle, número, piso/depto)",
  ...
  "en": {
    ...
    "ship-label-direccion": "Address (street, number, floor/apt)",
  ...
  "pt": {
    ...
    "ship-label-direccion": "Endereço (rua, número, andar/depto)",
