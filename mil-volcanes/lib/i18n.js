(function () {
  ...
  "es": {
    ...
    "ship-label-dni": "DNI",
    "ship-label-calle": "Calle",
    "ship-label-numero": "Número",
    "ship-label-piso-depto": "Piso / Depto (opcional)",
    "ship-label-ciudad": "Ciudad",
    "ship-label-cp": "Código postal",
    "ship-label-provincia": "Provincia",
    "ship-error": "Completá tus datos de envío para continuar.",
    "payment-mp": "Mercado Pago",
    "payment-transfer": "Transferencia bancaria",
    "bank-bank": "Banco",
    "bank-holder": "Titular",
    "bank-cbu": "CBU",
    "bank-alias": "Alias",
    "bank-hint": "Realizá la transferencia por el monto total y envianos el comprobante para coordinar el envío.",
    "btn-checkout-transfer": "Enviar comprobante",
  ...
  "en": {
    ...
    "ship-label-calle": "Street",
    "ship-label-numero": "Number",
    "ship-label-piso-depto": "Floor / Apt (optional)",
    "ship-label-ciudad": "City",
    "ship-label-cp": "Postal code",
    "ship-label-provincia": "Province/State",
    ...
    "bank-cbu": "CBU",
    "bank-alias": "Alias",
    "bank-hint": "Transfer the total amount and send us the receipt to arrange shipping.",
    "btn-checkout-transfer": "Send receipt",
  ...
  "pt": {
    ...
    "ship-label-calle": "Rua",
    "ship-label-numero": "Número",
    "ship-label-piso-depto": "Andar / Depto (opcional)",
    "ship-label-ciudad": "Cidade",
    "ship-label-cp": "Código postal",
    "ship-label-provincia": "Província/Estado",
    ...
    "bank-cbu": "CBU",
    "bank-alias": "Alias",
    "bank-hint": "Transfira o valor total e envie o comprovante para combinar o envio.",
    "btn-checkout-transfer": "Enviar comprovante",
