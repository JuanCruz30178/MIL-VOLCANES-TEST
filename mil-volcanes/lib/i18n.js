(function () {
  ...
  "es": {
    ...
    "shipping-title": "Datos de envío",
    "ship-label-nombre": "Nombre y apellido",
    "ship-label-email": "Email",
    "ship-label-telefono": "Teléfono",
    "ship-label-dni": "DNI",
    "ship-label-cp": "Código postal",
    "ship-label-sucursal": "Sucursal de retiro OCA",
    "ship-sucursal-placeholder": "Ingresá tu código postal primero",
    "ship-sucursal-choose": "Elegí una sucursal",
    "ship-sucursal-none": "No hay sucursales OCA para ese código postal",
    "ship-sucursal-hint": "Tu pedido se despacha por OCA y lo retirás en la sucursal que elijas — sin costo de envío.",
    "ship-error": "Completá tus datos de envío para continuar.",
    "btn-checkout-loading": "Procesando…",
    "checkout-error": "Hubo un problema al iniciar el pago. Probá de nuevo.",
    "cart-each": "c/u",
    "cart-remove": "Quitar",
    "confirm-remove-pack": "¿Estás seguro que deseas eliminar este item? Se eliminarán todos los productos del pack.",
    "btn-cancel": "Cancelar",
    "btn-ok": "OK",
    "btn-close": "Cerrar",
    "postpurchase-title": "¡Gracias por tu compra!",
    "postpurchase-body": "Te vamos a escribir por email para coordinar el envío. Si querés, también podés enviarnos el comprobante de tu pago.",
    "btn-send-receipt": "Enviar comprobante",
  ...
  "en": {
    ...
    "note-sauvblanc-torrontes": "Vibrant and seductive, with aromas of jasmine, orange blossom and citrusy notes of tropical fruit, with a smooth finish and refreshing acidity. Ideal paired with fish and seafood. Serve at 50–54°F.",
    "note-malbec-bonarda": "Vibrant and balanced, it combines the floral expression of violets and ripe plums from the Malbec with the freshness of raspberries and cherries from the Bonarda. On the palate it stands out for its soft tannins and a persistent finish. Serve at 61–64°F.",
    "note-cabsauv-merlot": "A balanced red with notes of blackberries, plums and green pepper, round and velvety tannins, a persistent, elegant finish. Serve at 61–64°F.",
    "note-sv-malbec": "It has the power and energy of a volcano, with notes of plum, ripe raspberries, violets and balsamic touches of barrel vanilla. Concentrated and persistent. Pairs beautifully with grilled red meats and roasted vegetables. Serve between 61°/64°F.",
    "note-sv-cabfranc": "Intense ruby red, with aromas of roasted pepper, sun-dried tomato, spice, chocolate and noble leather from its time in oak. Balanced entry, velvety tannins and an exceptional persistence on the palate. Serve between 61°/64°F.",
    ...
    "ship-label-nombre": "Full name",
    "ship-label-email": "Email",
    "ship-label-telefono": "Phone",
    "ship-label-dni": "ID number",
    "ship-label-cp": "Postal code",
    "ship-label-sucursal": "OCA pickup branch",
    "ship-sucursal-placeholder": "Enter your postal code first",
    "ship-sucursal-choose": "Choose a branch",
    "ship-sucursal-none": "No OCA branches found for that postal code",
    "ship-sucursal-hint": "Your order ships via OCA and you pick it up at the branch you choose — no shipping cost.",
    "ship-error": "Please fill in your shipping details to continue.",
    "btn-checkout-loading": "Processing…",
    "checkout-error": "There was a problem starting the payment. Please try again.",
    "cart-each": "each",
    "cart-remove": "Remove",
    "confirm-remove-pack": "Are you sure you want to remove this item? All the wines in the pack will be removed.",
    "btn-cancel": "Cancel",
    "btn-ok": "OK",
    "btn-close": "Close",
    "postpurchase-title": "Thank you for your purchase!",
    "postpurchase-body": "We'll email you to coordinate shipping. If you'd like, you can also send us your payment receipt.",
    "btn-send-receipt": "Send receipt",
  ...
  "pt": {
    ...
    "note-sauvblanc-torrontes": "Vibrante e sedutor, com aromas de jasmim, flor de laranjeira e notas cítricas de fruta tropical, com um final suave e acidez refrescante. Ideal para harmonizar com peixes e frutos do mar. Servir a 10–12°C.",
    "note-malbec-bonarda": "De perfil vibrante e equilibrado, combina a expressão floral de violetas e ameixas maduras do Malbec com a frescura de framboesas e cerejas do Bonarda. Na boca se destaca por seus taninos suaves e um final persistente. Servir a 16–18°C.",
    "note-cabsauv-merlot": "Tinto equilibrado com notas de amoras, ameixas e pimentão verde, taninos redondos e untuosos, final persistente e elegante. Servir a 16–18°C.",
    "note-sv-malbec": "Tem o poder e a energia de um vulcão, com notas de ameixa, framboesas maduras, violetas e toques balsâmicos de baunilha de barrica. Concentrado e persistente. Combina muito bem com carnes vermelhas grelhadas e legumes grelhados. Servir entre 16° / 18°C.",
    "note-sv-cabfranc": "Vermelho rubi intenso, com aromas de pimentão assado, tomate desidratado, especiarias, chocolate e couro nobre de sua passagem por carvalho. Entrada equilibrada, taninos aveludados e uma persistência excepcional na boca. Servir entre 16° / 18°C.",
    ...
    "shipping-title": "Dados de envio",
    "ship-label-nombre": "Nome completo",
    "ship-label-email": "E-mail",
    "ship-label-telefono": "Telefone",
    "ship-label-dni": "Documento de identidade",
    "ship-label-cp": "Código postal",
    "ship-label-sucursal": "Agência de retirada OCA",
    "ship-sucursal-placeholder": "Digite seu código postal primeiro",
    "ship-sucursal-choose": "Escolha uma agência",
    "ship-sucursal-none": "Nenhuma agência OCA encontrada para esse código postal",
    "ship-sucursal-hint": "Seu pedido é enviado pela OCA e você retira na agência que escolher — sem custo de envio.",
    "ship-error": "Preencha seus dados de envio para continuar.",
    "btn-checkout-loading": "Processando…",
    "checkout-error": "Houve um problema ao iniciar o pagamento. Tente novamente.",
    "cart-each": "cada",
    "cart-remove": "Remover",
    "confirm-remove-pack": "Tem certeza de que deseja remover este item? Todos os vinhos do pack serão removidos.",
    "btn-cancel": "Cancelar",
    "btn-ok": "OK",
    "btn-close": "Fechar",
    "postpurchase-title": "Obrigado pela sua compra!",
    "postpurchase-body": "Vamos escrever para você por e-mail para combinar o envio. Se quiser, também pode nos enviar o comprovante do pagamento.",
    "btn-send-receipt": "Enviar comprovante",
