(function () {
  ...
  "es": {
    ...
    "note-sv-cabsauv": "Pimienta negra, moras y cerezas negras maduras, con vainilla y especias de roble. Taninos maduros, final largo y persistente.",
    ...
    "footer-tag": "Bodega familiar y exportadora. Vinos premium de Mendoza, Argentina, nacidos junto a la Reserva Natural La Payunia.",
    ...
    "age-gate-text1": "Para poder navegar este sitio, debés tener la edad legal para consumir alcohol en tu país de residencia.",
    "age-gate-text2": "Al presionar el botón «SÍ», certificás que cumplís con la edad legal.",
    "age-gate-yes": "SÍ",
    "age-gate-no": "NO",
    "age-gate-no-msg": "Para navegar este sitio debés tener la edad legal para consumir alcohol.",
    ...
    "mix-sv-note": "2 botellas de cada: Malbec, Cabernet Franc y Cabernet Sauvignon.",
  ...
  "en": {
    ...
    "note-sv-cabsauv": "Black pepper, blackberries and ripe black cherries, with vanilla and oak spice. Ripe tannins, long and persistent finish.",
    ...
    "footer-tag": "A family-run, export-focused winery. Premium wines from Mendoza, Argentina, born alongside the La Payunia Natural Reserve.",
    ...
    "mix-sv-note": "2 bottles of each: Malbec, Cabernet Franc and Cabernet Sauvignon.",
  ...
  "pt": {
    ...
    "note-sv-cabsauv": "Pimenta-preta, amoras e cerejas negras maduras, com baunilha e especiarias de carvalho. Taninos maduros, final longo e persistente.",
    ...
    "footer-tag": "Vinícola familiar e exportadora. Vinhos premium de Mendoza, Argentina, nascidos junto à Reserva Natural La Payunia.",
    ...
    "mix-sv-note": "2 garrafas de cada: Malbec, Cabernet Franc e Cabernet Sauvignon.",
